...
<html lang="en">
  <head>
    ...
    <link href="{{asset('admin/layoutslogin/assets/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('admin/layoutslogin/assets/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{asset('admin/layoutslogin/assets/css/style.css')}}" rel="stylesheet">
                  ...
                  <div class="_mn_df">
                    ...
                    <div class="checkbox form-group">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" name="remember" id="">
